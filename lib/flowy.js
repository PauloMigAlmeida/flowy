export default function flowy(canvas, grab, release, snapping, rearrange, spacing_x, spacing_y) {

    //TODO I'm not entirely sure that I need this function really... it will become more obvious
    // once I try to refactor the import/export routines
    function makeid() {
    ...
    flowy.load = function () {
        ...
        function moveChildrenToParentPos(id) {
            console.log('moveChildrenToParentPos');
        ...
        function moveChildrenToParentBlockInfo(id) {
            console.log('moveChildrenToParentBlockInfo');
            let childern_block_idx = [];
